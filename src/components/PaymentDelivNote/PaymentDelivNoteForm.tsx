...
import { createPaymentDelivNoteAPI } from "^/services/payment-deliverynote";
import { PaymentDelivNoteFormProps } from "^/@types/models/paymentdelivnote";
import Loading from "../Loading";

const PaymentDelivNoteForm: FC<PaymentDelivNoteFormProps> = ({
  mode,
  initialFormVals,
  onSubmitOk,
}) => {
  ...
  const onSubmit = async (data: IPaymentPurchaseForm) => {
    ...
    const res = await createPaymentDelivNoteAPI(session, prm);
                    ...
                    <Input
                      ...
                      {...register(`items.${index}.quantity` as const, {
                        ...
                        onChange: () => {
                          ...
                          const currQtyVal = getValues(
                            `items.${index}.quantity`
                          );

                          if (
                            currQtyVal > initialFormVals.items[index].quantity
                          )
...
export default PaymentDelivNoteForm;
